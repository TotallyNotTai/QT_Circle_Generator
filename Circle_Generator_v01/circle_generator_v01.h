#ifndef CIRCLE_GENERATOR_V01_H
#define CIRCLE_GENERATOR_V01_H
...
class Circle_generator{
    public:
        ...
        */
         ...
         */
        void loop_circle_generator(int iloops, int isize, int imin_num_dots, int imax_num_dots, float inoise, int iradius, std::string output_type);
