 ...
 * verison update compared to v04:
 *      - splitting into two files, first as list of circle center coordinates, second as list of all pixel coordinates
 */
...
int main()
{
    ...
    test.output_directory = "..\\..\\generated_test_data\\";
   ...
   //training data
   test.loop_circle_generator(120, 30, 300, 70, 90, 0.005, 0, 10, radii, radii_size);
   // //test data
   // test.loop_circle_generator(40, 10, 300, 70, 90, 0.005, 0, 10, radii, radii_size, "test", "txt", true);
   // //validation data
   // test.loop_circle_generator(60, 20, 300, 70, 90, 0.005, 0, 10, radii, radii_size, "validation", "txt", true);
